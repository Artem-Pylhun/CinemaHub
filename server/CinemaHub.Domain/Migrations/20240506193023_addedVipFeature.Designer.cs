...
namespace CinemaHub.Domain.Migrations
{
    ...
    [Migration("20240506193023_addedVipFeature")]
    partial class addedVipFeature
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CinemaHub.Domain.Entities.Screening", b =>
                {
                    ...
                    b.Property<float>("UsualTicketsPrice")
                        .HasColumnType("real");

                    b.Property<float>("VIPTicketsPrice")
                        .HasColumnType("real");
            ...
            modelBuilder.Entity("CinemaHub.Domain.Entities.Ticket", b =>
                {
                    ...
                    b.HasOne("CinemaHub.Domain.Entities.Seat", "Seat")
                        .WithMany()
